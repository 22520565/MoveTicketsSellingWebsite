...
public interface UserDetailsServiceInterface<TUserDetailsRequestDto extends UserDetailsRequestDtoInterface, TUserDetailsResponseDto extends UserDetailsResponseDtoInterface, TUserDetails extends UserDetailsInterface> {
    @Nullable
