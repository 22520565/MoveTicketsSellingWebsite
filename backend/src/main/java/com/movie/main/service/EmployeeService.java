...
public class EmployeeService
        extends AbstractEntityService<EmployeeRequestDto, EmployeeResponseDto, Employee, Integer>
    ...
    public EmployeeService(
            @NotNull final EmployeeRepository repository,
    ...
    public EmployeeResponseDto createResponseDtoFromEntity(@NotNull final Employee employee) {
        return new EmployeeResponseDto(
                this.userService.createResponseDtoFromEntity(employee.getUser()),
    ...
    protected Employee createEntityFromRequestDto(@NotNull final EmployeeRequestDto requestDto) {
        return new Employee(
                this.userService.createEntityFromRequestDto(requestDto.userRequestDto()),
                requestDto.jobTitle(),
                requestDto.salary(),
    ...
    @Override
    protected Employee updateEntityFromRequestDto(
            @NotNull final Employee employee,
